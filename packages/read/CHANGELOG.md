...
- **read:** declare tenant reference dependency ([06cfce6](https://github.com/sanshan/event-driven-platform/commit/06cfce6))
- **read:** add tenant to Read contract ([db4bf8e](https://github.com/sanshan/event-driven-platform/commit/db4bf8e))
